...
.defines(function(){
    EntityPlayer = ig.Entity.extend({
        animSheet: new ig.AnimationSheet( 'media/P2.png', 16, 16 ),
        ...
        setupAnimation: function(offset){
			...
			this.addAnim('climb', 0.00001, [6+offset,7+offset]);
        },
        ...
        draw: function(){
            ...
            this.parent();
			this.statText.draw("Hit Points: ", 1,20);
			this.statText.draw(this.health, 49,20);
	...
	EntityFireball = ig.Entity.extend({
        size: {x: 5, y: 3},
        animSheet: new ig.AnimationSheet( 'media/fireball.png', 5, 3 ),
        maxVel: {x: 200, y: 0},
        type: ig.Entity.TYPE.NONE,
        checkAgainst: ig.Entity.TYPE.B,
        collides: ig.Entity.COLLIDES.PASSIVE,
